...
class ItineraryListViewController:UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let incheonAirport = Place(name: "Incheon Airport", coordinate: (37.460448, 126.440619), placetype: .DeparturePoint)
        ...
        let cdgAirport = Place(name: "Charles de Gaulle Airport", coordinate: (49.009845, 2.547946), placetype: .MiddlePoint)
        FranceNParis.addPlace(cdgAirport)
        let eiffelTower = Place(name: "Eiffel Tower", coordinate: (48.858557, 2.294411), placetype: .MiddlePoint)
        ...
        let heathrowAirport = Place(name: "Heathrow Airport", coordinate: (51.470009, -0.454285), placetype: .MiddlePoint)
        EnglandNLondon.addPlace(heathrowAirport)
        let theBritishMuseum = Place(name: "The British Museum", coordinate: (51.519387, -0.126667), placetype: .MiddlePoint)
        EnglandNLondon.addPlace(theBritishMuseum)
        let buckinghamPalace = Place(name: "Buckingham Palace", coordinate: (51.501364, -0.141718), placetype: .MiddlePoint)
        ...
        let newarkAirport = Place(name: "Newark Liberty International Airport", coordinate: (40.689800, -74.174527), placetype: .MiddlePoint)
        USANNewYork.addPlace(newarkAirport)
        let timesSquare = Place(name: "Times Square", coordinate: (40.758895, -73.984702), placetype: .MiddlePoint)
        USANNewYork.addPlace(timesSquare)
        let centralPark = Place(name: "Central Park", coordinate: (40.782842, -73.965325), placetype: .ArrivalPoint)
